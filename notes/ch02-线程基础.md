...
![guangzhou-tushuguan](../images/gzlib.jpg)
...
- `wait()`、`notify()`、`notifyAll()` **必须**在 `synchronized` 代码块内调用
- 调用这些方法的对象就是**锁对象**
...
**原因**：防止**假唤醒（Spurious Wakeup）** - `wait()` 可能无原因被唤醒，使用 `while` 确保醒来后重新检查条件。
...
- [Library.java](https://github.com/upangka/ComicJava/blob/main/src/cn/comicjava/ch02/wow/wait/Library.java)
- [Person.java](https://github.com/upangka/ComicJava/blob/main/src/cn/comicjava/ch02/wow/wait/Person.java)
- [Student.java](https://github.com/upangka/ComicJava/blob/main/src/cn/comicjava/ch02/wow/wait/Student.java)
- [Worker.java](https://github.com/upangka/ComicJava/blob/main/src/cn/comicjava/ch02/wow/wait/Worker.java)
- [Main.java](https://github.com/upangka/ComicJava/blob/main/src/cn/comicjava/ch02/wow/wait/Main.java)
